...
function Home() {
    ...
    const [profilePic, setProfilePic] = React.useState(defpic); 
        ...
        const fetchProfilePic = async () => {
            if (auth?.id) { // Ensure the id exists in the auth context
                try {
                    ...
                    setProfilePic(response.data.profilePic || defpic); 
            ...
            <AppBar position="static" style={{ color: theme.palette.primary.main, backgroundColor: theme.palette.background.default }}>
                <Toolbar>
                    ...
                    <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
                        <Button color="inherit" onClick={() => navigate('/home')} style={{ color: 'black' }}>
