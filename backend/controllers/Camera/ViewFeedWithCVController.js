...
const ViewLiveFeed = async (req, res) => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadOpenCv()
        .then(() => {
            ...
            if (Hls.isSupported()) {
                const hls = new Hls({
                    liveSyncDurationCount: 5, // You can adjust this value
                    maxBufferLength: 4, // Adjust this for more buffer length
                    liveMaxLatencyDurationCount: 6 // Must be greater than liveSyncDurationCount
                });
