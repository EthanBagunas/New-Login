...
const InsertPurok = (req, res) => {
  const { purokName, brgyName, type, province, region, purokPresident } = req.body;
  ...
  db.query(insertUserQuery, [purokName, brgyName, type, province, region, purokPresident], (error, result) => {
